...
import { Chunk, OT, pipe, T } from '@contentlayer-temp/utils/effect'
...
export const fetchAllDocuments = ({
  ...
  pipe(
    T.gen(function* ($) {
      ...
      const documents = yield* $(
        pipe(
          ...
          OT.withSpan('@contentlayer-temp/source-contentlayer/fetchData:makeCacheItems', {
    ...
    OT.withSpan('@contentlayer-temp/source-contentlayer/fetchData:fetchAllDocuments', {
...
const getAllEntries = (
  ...
  pipe(
    ...
    OT.withSpan('@contentlayer-temp/source-contentlayer/fetchData:getAllEntries'),
  )
...
const getAllAssets = (
  ...
  pipe(
    ...
    OT.withSpan('@contentlayer-temp/source-contentlayer/fetchData:getAllAssets'),
  )
