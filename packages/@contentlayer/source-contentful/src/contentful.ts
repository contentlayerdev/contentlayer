...
export const environmentGetContentTypes = (
  ...
  pipe(
    ...
    OT.withSpan('@contentlayer-temp/source-contentlayer/contentful:environmentGetContentTypes'),
  )
...
export const environmentGetEntries = ({
  ...
  pipe(
    ...
    OT.withSpan('@contentlayer-temp/source-contentlayer/contentful:environmentGetEntries'),
  )
...
export const environmentGetAssets = ({
  ...
  pipe(
    ...
    OT.withSpan('@contentlayer-temp/source-contentlayer/contentful:environmentGetAssets'),
  )
...
export const getEnvironment = ({
  ...
  return pipe(
    ...
    OT.withSpan('@contentlayer-temp/source-contentlayer/contentful:getEnvironment'),
