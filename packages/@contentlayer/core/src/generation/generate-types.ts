import { casesHandled, pattern } from '@contentlayer-temp/utils'
...
export const renderTypes = ({
  ...
  const importsForRawTypes = pattern
    ...
    .with('local', () => `import * as Local from 'contentlayer-temp/source-files'`)
    .with('contentful', () => `import * as Contentful from '@contentlayer-temp/source-contentful'`)
    .otherwise(() => ``)
...
import type { Markdown, MDX, ImageFieldData, IsoDateTimeString } from 'contentlayer-temp/core'
${importsForRawTypes}
