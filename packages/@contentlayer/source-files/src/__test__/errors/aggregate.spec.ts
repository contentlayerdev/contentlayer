...
test.describe('CouldNotDetermineDocumentTypeError', () => {
  test('should print 4 errors', () => {
...
//   test('should print 24 errors - truncated', () => {
//     const errorString = aggregateFetchDataErrors({
...
//   test('should print 24 errors - full', () => {
//     const errorString = aggregateFetchDataErrors({
//       errors: makeErrors({ CouldNotDetermineDocumentTypeError: 24 }),
//       options,
//       flags,
